...
<section class="info-section">
    <div class="info-section-container">
        <div class="info-section-image">
            <img class="slide-bg" src="<?php echo get_template_directory_uri(); ?>/images/temp/akamode-2.jpg" alt="دستکش چرمی قهوه‌ای">
            <img class="slide-bg" src="<?php echo get_template_directory_uri(); ?>/images/temp/akamode-3.jpg" alt="دستکش چرمی قهوه‌ای">
        </div>
        <div class="info-section-text">
            <h3 class="subtitle">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</h3>
            <h2 class="title">آیتم های این لوک</h2>
            <div class="info">
                <div class="info-item is-open">
                ...
                <div class="info-item">
                    ...
                    <div class="info-content">
                        <p>محتوای نظرات اول در اینجا قرار می‌گیرد...</p>
                    </div>
                </div>
                <div class="info-item">
                    <button class="info-header">
                    ...
                    <div class="info-content">
                        <p>محتوای نظرات دوم در اینجا قرار می‌گیرد...</p>
                    </div>
                </div>
                <div class="info-item">
                    <button class="info-header">
                    ...
                    <div class="info-content">
                        <p>محتوای نظرات سوم در اینجا قرار می‌گیرد...</p>
                    </div>
                </div>
            </div>
        </div>
