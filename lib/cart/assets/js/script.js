jQuery(document).ready(function($) {
    ...
    function renderInitialTotal() {
        ...
        // Calculate total using the same logic (Sale Price OR Regular Price)
        cart.forEach(item => {
        ...
        $('.final-total-price').text(new Intl.NumberFormat('fa-IR').format(total) + ' تومان');
    }
