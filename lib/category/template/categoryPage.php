...
<div class="main-container">
        ...
        <div class="page-content-container">
            ...
            <section class="toolbar">
                <div class="sort-wrapper">
                    <div class="toolbar-btn" id="cat_sortTrigger">
                        <i class="icon-sort-aka"></i>
                        <span id="cat_sortLabel">مرتب‌سازی بر اساس : جدیدترین</span>
                    </div>
                    <div class="sort-dropdown" id="cat_sortDropdown">
                ...
                <div class="toolbar-btn" id="cat_filterTrigger">
    ...
    <aside class="filter-sidebar" id="cat_sidebar">
        <div class="filter-header">
            ...
            <div class="close-btn" id="cat_closeFilter">
        ...
        <div class="filter-body">
            ...
            <div class="f-section" style="border:none;">
                ...
                <div class="f-content">
                    <div class="slider-container" id="cat_sliderContainer">
                        <div class="slider-track">
                            <div class="slider-fill" id="cat_sliderFill"></div>
                            <div class="slider-thumb" id="cat_sliderThumb"></div>
                        </div>
                    </div>
                    <div class="price-info">
                        <span>۰ تومان</span>
                        <span id="cat_priceValue">۲۳,۰۰۰,۰۰۰ تومان</span>
                    </div>
                </div>
            </div>
        </div>
